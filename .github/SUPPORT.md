# Getting help with ihpdr

Thanks for using ihpdr. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/ihpdr/issues) to make sure the 
